...
| W2 | **Expensive reach / DFS** | Eisenstat–Liu symmetric pruning | ~~full GP-LU DFS~~ → **symmetric pruning (Phase 2)** | [2 (#134)](native-klu-performance.md) | **Phase 2 (pruning):** 2D Poisson 256² **3.6× → 1.5×** (0.68s → 0.29s; **meets the 1.5× DoD**), 128² 3.5× → 1.7×. Fill unchanged (= KLU). Same residuals; ASan-clean. |
